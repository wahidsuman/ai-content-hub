      ...
      if (image.source === 'dalle') {
        ...
        imageHtml = `
          <div class="article-image">
            ...
            <p class="image-credit" style="font-size:13px;color:#666;margin-top:10px;text-align:center;font-style:italic;background:#f5f5f5;padding:8px;border-radius:4px;">
              📸 Photo Credit: ${image.credit || 'Generated by DALL-E 3 AI for AgamiNews'}
            </p>
          </div>
        `;
        ...
        imageHtml = `
          <div class="article-image">
            ...
            <p class="image-credit" style="font-size:13px;color:#666;margin-top:10px;text-align:center;font-style:italic;background:#f5f5f5;padding:8px;border-radius:4px;">
              📸 Photo Credit: Image generation in progress
            </p>
          </div>
        `;
      } else {
        ...
        imageHtml = `
          <div class="article-image">
            <img src="${image.url}" alt="${image.alt}" style="width:100%;border-radius:12px;">
            <p class="image-credit" style="font-size:13px;color:#666;margin-top:10px;text-align:center;font-style:italic;background:#f5f5f5;padding:8px;border-radius:4px;">
              📸 Photo Credit: ${image.credit || 'Stock Photo'}
            </p>
          </div>
        `;
      }
